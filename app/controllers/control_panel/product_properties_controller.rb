class ControlPanel::ProductPropertiesController < ApplicationController
  ...
  def create
    ...
    respond_to do |format|
      if @product_property.save
        format.html { redirect_to control_panel_product_properties_path, notice: 'Product property was successfully created.' }
  ...
  def update
    respond_to do |format|
      if @product_property.update(product_property_params)
        format.html { redirect_to control_panel_product_properties_path, notice: 'Product property was successfully updated.' }
  ...
  def destroy
    ...
    respond_to do |format|
      format.html { redirect_to control_panel_product_properties_path, notice: 'Product property was successfully destroyed.' }
  ...
  private
    ...
    def product_property_params
      params.require(:product_property).permit(:product_id, :size, :color, :quantity)
    end
end
